				...
				<div class = "card">
						<div class = "card-body">
								<div class = "card-header">
									<h3>Google survey sheet bootleg</h3>
								</div>
									<ul class = "nav nav-tabs">
										<li class = "nav-item"><a  class = "nav-link active" href = "#part_info" data-toggle = "tab">Participant Information</a></li>
										<li class = "nav-item"><a class = "nav-link" href = "#econ_status" data-toggle = "tab">Economic Status</a></li>
										<li class = "nav-item"><a class = "nav-link" href = "#comm_prof" data-toggle = "tab">Community Profile</a></li>
										<li class = "nav-item"><a class = "nav-link" href = "#dis_prep" data-toggle = "tab">Disaster Preparedness</a></li>
										<li class = "nav-item"><a class = "nav-link" href = "#health_rel" data-toggle ="tab">Health Related</a></li>
										<li class = "nav-item"><a class = "nav-link" href = "#climate_imp" data-toggle = "tab">Climate Impacts</a></li>
									</ul>
									
								<div class = "tab-content">
									<div id = "part_info" class = "tab-pane">
									<div class ="form-group">
										<h4>Block I Participant Profile</h4>
										<hr>
									</div>
										...
										<div class = "card-body">
											...
											<div class = "form-group col-m-4">
												<label>Occupation: </label>
													<select name = "OCC_ID" required class="form-control">
									...
									<div class = "modal-dialog">
										<div class = "modal-content">
											...
											<div class = "modal-footer">
												...
												<button type = "button" class = "btn btn-danger" data-dismiss="close">Close</button>
							...
							<div id = "econ_status" class = "tab-pane">
								<div class = "form-group">
									<h4>Block II Economic Status</h4>	
									<hr>
								</div>
								...
								<div class = "card">
									<div class = "card-body">
										...
										<div class = "row">
												<div class = "form-group col-lg-4">
												<label>Main source of income in your family:</label>
												<input type="text" name="ES_MSI" class = "form-control">
												</div>
												<div class = "form-group col-lg-4">
													<label>Total expenses in a month:</label>
													<input type="number" name="ES_TEM" class="form-control">
												</div>
